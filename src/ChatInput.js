  ...
  render() {
    ...
    return (
      <div className="divRow">
        <div>
          <input className="chatInput" type="text" ref="messageInput" placeholder="Enter Message..."  onChange={this.handleChange} onKeyPress={event => {if (event.key === 'Enter' && this.state.text != "") {this.sendMessage()}}}></input>
        </div>
        <div>
